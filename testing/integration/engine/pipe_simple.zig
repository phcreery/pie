...
test "simple test modules" {
    ...
    try pipeline.connectModulesName(mod_test_i_1234, "output", mod_test_multiply, "input");
    try pipeline.connectModulesName(mod_test_multiply, "output", mod_test_o_2468, "input");
