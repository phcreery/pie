...
pub fn Musubi(
    ...
    return struct {
        ...
        pub fn traverseTree(self: *Self, origin: Vertex, algorithm: TreeTraverseAlg) !Path {
            ...
            var path = Path.initCapacity(self.alloc, 0) catch return GraphError.OutOfMemory;
        ...
        fn bfsDfsA(
            ...
            const path = Path.initCapacity(self.alloc, 600) catch return GraphError.OutOfMemory;
